...
commands:
    ...
    echo -e "rpcuser=ducatsrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/Ducats/Ducats.conf"
    chmod 600 "/Users/${USER}/Library/Application Support/Ducats/Ducats.conf"
