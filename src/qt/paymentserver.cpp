...
const QString BITCOIN_IPC_PREFIX("Ducats:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Ducats: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Ducats: click-to-pay handler");
    else
...
{
    // clicking on Ducats: URLs creates FileOpen events on the Mac:
